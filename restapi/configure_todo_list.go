...
import (
	...
	"github.com/kg0r0/go-swagger-example/models"
	"github.com/kg0r0/go-swagger-example/restapi/operations"
	"github.com/kg0r0/go-swagger-example/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../go-swagger-example --name TodoList --spec ../swagger.yml
